...
export default function ProjectsPage() {
    return (
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pb-32 bg-[#0a0a0a]">
            <section id="projects" className="py-20 section-transition translate-y-4 animate-fade-in-up">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="group relative rounded-3xl overflow-hidden bg-[#1a1a1a] border border-white/10 hover:border-purple-400 transition-colors shadow-purple-500/10">
                    ...
                    <div className="group relative rounded-3xl overflow-hidden bg-[#1a1a1a] border border-white/10 hover:border-cyan-400 transition-colors shadow-cyan-500/10">
                        <div className="aspect-video w-full overflow-hidden bg-gray-900">
                    ...
                    <div className="group relative rounded-3xl overflow-hidden bg-[#1a1a1a] border border-white/10 hover:border-lime-400 transition-colors shadow-lime-500/10">
                        <div className="aspect-video w-full overflow-hidden bg-gray-900">
